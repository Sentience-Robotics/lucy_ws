...
In the **Lucy Control Center**, enable **Core + Control Panel**. The panel is at [http://localhost:5000](http://localhost:5000) (or **5001** if 5000 is in use). The launcher prints the exact URL when the panel is running.
